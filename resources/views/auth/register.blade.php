<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <input id="id_card_parent" type="file" name="id_card_parent" accept="image/*" class="block mt-1 w-full">
        ...
        <div class="mt-4">
            ...
            <input id="id_family_card" type="file" name="id_family_card" accept="image/*" class="block mt-1 w-full">
        ...
        <div class="mt-4">
            ...
            <input id="kip" type="file" name="kip" accept="image/*" class="block mt-1 w-full">
